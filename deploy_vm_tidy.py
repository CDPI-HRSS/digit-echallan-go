...
try:
    ...
    ssh.exec_command(f'cd /home/percy/CDPI/echallan-services && {go_path} mod tidy && nohup {go_path} run cmd/echallan-services/main.go > service.log 2>&1 &')
    ssh.exec_command(f'cd /home/percy/CDPI/echallan-calculator && {go_path} mod tidy && nohup {go_path} run cmd/echallan-calculator/main.go > calc.log 2>&1 &')
